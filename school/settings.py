...
# and README.rst, a school directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'school')
...
SECRET_KEY = 'x2s+kzukvtl$vzs5amiucyhh_kbufw11qif-=da9%xnbsqxniv'
